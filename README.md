...
- [x] **카메라 및 렌더러(Renderer) 기능 강화**: [renderer.cpp](file:///home/sinokadev/notengine/src/renderer.cpp)의 `renderObject`에 MVP(Model-View-Projection) 행렬 변환 및 쉐이더 적용 로직을 연계하여 3D 좌표계 렌더링 지원
