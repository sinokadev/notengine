...
int main() {
    ...
    auto material =
        std::make_shared<knot::PbrMaterial>(
            shader,
            glm::vec3(1.0f),
            0.2f,
            0.0f,
    ...
    auto model =
        std::make_shared<knot::Model>(mesh, material);
    ...
    auto createObjects = [&](int count) {
        ...
        for (int i = 0; i < count; ++i) {
            ...
            auto object =
                std::make_shared<knot::Object>(model);
    ...
    auto printResults = [&]() {
        ...
        std::cout
            << std::left
            << std::setw(15) << "Objects"
            << std::setw(18) << "Average FPS"
            << std::setw(18) << "Minimum FPS"
            << "\n";
